...
const COLLECTIONS = [
  ...
  },
  {
    ...
    attributes: [
      ...
      { key: 'actor_id', type: 'string', size: 100 },
      { key: 'post_id', type: 'string', size: 100 },
      createdAt,
    ],
    indexes: [
      { key: 'user_idx', type: 'key', attributes: ['user_id'] },
      { key: 'user_actor_post_idx', type: 'key', attributes: ['user_id', 'actor_id', 'post_id'] },
    ],
  },
  {
    id: 'community_profiles',
    ...
    attributes: [
      ...
      { key: 'location', type: 'string', size: 200 },
      { key: 'role', type: 'string', size: 200 },
      { key: 'interests', type: 'string', size: 1000 },
      createdAt,
      updatedAt,
    ],
    indexes: [{ key: 'user_id_unique', type: 'unique', attributes: ['user_id'] }],
  },
  {
    ...
    indexes: [
      ...
      { key: 'likes_count_idx', type: 'key', attributes: ['likes_count'] },
    ],
  },
  {
    ...
    attributes: [
      { key: 'user_id', type: 'string', size: 100, required: true },
      { key: 'post_id', type: 'string', size: 100, required: true },
